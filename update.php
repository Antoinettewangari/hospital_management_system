...
$id=$_GET['id'];
$select_query=mysqli_query($conn,"select * from administration where id=$id")or die(mysqli_error($conn));
...
$update_query=mysqli_query($conn," update administration set name='$name',nhifnumber='$nhifnumber',gender='$gender',age='$age',
