...
$db_records=mysqli_query($conn,"select*from administration")or die(mysqli_error($conn));
?>
      ...
      <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Hello, Mwangi !</span>
                ...
                <div class="col-sm-10">
                    <table class="table table-bordered">
                        ...
                        <?php foreach($db_records as $record){?>
                            ...
                            <td><?php echo $record['nhifnumber'];?></td>
                            <td><?php echo $record['gender'];?></td>
                            <td><?php echo $record['age'];?></td>
                            <td><?php echo $record['patientnumber'];?></td>
